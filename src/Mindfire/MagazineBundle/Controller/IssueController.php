...
use Mindfire\MagazineBundle\Entity\Issue;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $issues = $em->getRepository('MindfireMagazineBundle:Issue')->findAll();
    ...
    {
        $issue = new Issue();
        $form = $this->createForm('Mindfire\MagazineBundle\Form\IssueType', $issue);
    ...
    {
        $deleteForm = $this->createDeleteForm($issue);
        $editForm = $this->createForm('Mindfire\MagazineBundle\Form\IssueType', $issue);
