...
use Mindfire\MagazineBundle\Entity\Publication;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $publications = $em->getRepository('MindfireMagazineBundle:Publication')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Mindfire\MagazineBundle\Form\PublicationType', $publication);
    ...
    {
        $deleteForm = $this->createDeleteForm($publication);
        $editForm = $this->createForm('Mindfire\MagazineBundle\Form\PublicationType', $publication);
