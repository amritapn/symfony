...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'mindfire', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Test/firstBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Symfony/MagazineBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Test\\firstBundle\\Entity');
        $c->addDriver($b, 'Symfony\\MagazineBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('firstBundle' => 'Test\\firstBundle\\Entity', 'SymfonyMagazineBundle' => 'Symfony\\MagazineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8818acbc674750db96f662a06af7c3808c6b134b9c900b899b481e31de978d51');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Test/firstBundle/Resources/views'), 'first');
        $instance->addPath(($this->targetDirs[3].'/src/Symfony/MagazineBundle/Resources/views'), 'SymfonyMagazine');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('symfony');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5909874b736ff1.55861327')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'firstBundle' => 'Test\\firstBundle\\firstBundle',
                'SymfonyMagazineBundle' => 'Symfony\\MagazineBundle\\SymfonyMagazineBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'firstBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Test/firstBundle'),
                    'namespace' => 'Test\\firstBundle',
                ),
                'SymfonyMagazineBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Symfony/MagazineBundle'),
                    'namespace' => 'Symfony\\MagazineBundle',
                ),
            ),
