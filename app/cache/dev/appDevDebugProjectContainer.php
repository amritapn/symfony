...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'mindfire', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Test/firstBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Mindfire/MagazineBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Test\\firstBundle\\Entity');
        $c->addDriver($b, 'Mindfire\\MagazineBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('firstBundle' => 'Test\\firstBundle\\Entity', 'MindfireMagazineBundle' => 'Mindfire\\MagazineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4d3d38ea8d1344b37ed2eebe80adee16501de894f5b89e536e77eee3523c20c8');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Mindfire/MagazineBundle/Resources/views'), 'MindfireMagazine');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5909d094546220.55090210')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MindfireMagazineBundle' => 'Mindfire\\MagazineBundle\\MindfireMagazineBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MindfireMagazineBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Mindfire/MagazineBundle'),
                    'namespace' => 'Mindfire\\MagazineBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
